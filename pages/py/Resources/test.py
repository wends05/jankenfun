...
# Load a sound file
sound_file = "Resources/BGmusic.mp3"
...
while True:
    imgBG = cv2.imread("Resources/BGG.png")
    ...
    if startGame:
        ...
        if stateResult is False:
            ...
            cv2.putText(imgBG, str(int(timer)), (605, 160), cv2.FONT_HERSHEY_PLAIN, 6, (255, 0, 255), 4)
            pygame.init()
